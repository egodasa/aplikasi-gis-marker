//START OF DATA
    ...
    function initMap(){
        ...
        //Menambah legenda pada peta
        var legend = L.control({position: 'bottomright'});
        legend.onAdd = function (map) {
            var div = L.DomUtil.create('div', 'info-map legend-map')
            div.innerHTML = "<i style='background:grey'></i> ----------------<br/>"
            div.innerHTML += "<i style='background:blue'></i> --------<br/>"
            div.innerHTML += "<i style='background:aqua'></i> -------------------<br/>"
            div.innerHTML += "<i style='background:red'></i> ------------<br/>"
            div.innerHTML += "<img src='http://localhost/peta-new/dist/css/images/marker-icon.png' /> -------------------<br/>"
            return div;
        };
        legend.addTo(mymap);
        //plugin print leaflet
